...
import static com.drake.brv.layoutmanager.ConcatAdapterUtils.offsetPositionOnAdapter;
...
public class StickyHeadersGridLayoutManager extends OpenGridLayoutManager {
    ...
    private StickyHeaderProvider stickyHeaderProvider = new StickyHeaderProvider() {
        @Override
    ...
    private void createStickyHeader(@NonNull RecyclerView.Recycler recycler, int position) {
        ...
        else    if (adapterPositionPair.first instanceof BindingAdapter && ((BindingAdapter)adapterPositionPair.first).getOnHoverAttachListener() != null){
            ((BindingAdapter)adapterPositionPair.first).getOnHoverAttachListener().attachHover(stickyHeader);
        }
    ...
    private void scrapStickyHeader(@Nullable RecyclerView.Recycler recycler) {
        ...
        if (adapterPositionPair.first instanceof OnViewStickyListener) {
            ...
            ((BindingAdapter)adapterPositionPair.first).getOnHoverAttachListener().detachHover(stickyHeader);
        }
